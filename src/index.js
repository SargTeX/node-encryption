...
module.exports.oneWay = function(model, fieldName, options) {
	if (!options) options = {};
	...
	model.pre('save', function(callback) {
		var object = this;
	...
	if (options.compareMethod) model.methods[options.compareMethodName] = function(candidate, callback) {
